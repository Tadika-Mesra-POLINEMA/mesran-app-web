...
const Hero = () => {
  return (
    <section className="relative w-fill h-[100dvh] bg-cover bg-center bg-[url('/images/hero.jpg')] bg-[#F6F6F6]">
      <div className="w-full p-6 lg:p-20 flex flex-col gap-4 align-bottom h-fit absolute bottom-0 bg-gradient-to-b from-transparent to-[#000000] to-100% to-opacity">
